...
import com.example.springboot.api.controllers.ClientController;
import com.example.springboot.api.payloads.ApiResponse;
import com.example.springboot.api.payloads.ExceptionResponse;
...
public class RestControllerExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> resolveException(MethodArgumentNotValidException ex) {
		logger.info(ex.getBindingResult().getFieldErrors());
